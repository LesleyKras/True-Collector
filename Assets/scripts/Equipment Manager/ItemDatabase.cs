...
public class ItemDatabase : MonoBehaviour {
	...
	void Start() {
		...
		items.Add(new Item(1, "Hand Gun", "Make sure the safety is on!", 0.0F, 25.0F, 0.5F, 0, Item.ItemType.Weapon, "shoot", 12));
		items.Add(new Item(2, "Rock", "Don't you go throwing this at people now!", 1.0F, 5.0F, 0.1F, 0, Item.ItemType.Weapon, "throw", 1));
        ...
        items.Add(new Item(5, "Magical Item Fragment", "A part of something bigger.", 0, 0, 0, 0, Item.ItemType.Misc, "None", 0));
    }
